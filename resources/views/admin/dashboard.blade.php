        ...
        <div class="flex-1 overflow-auto">
            ...
            <main class="p-6 animate__animated animate__fadeIn animate__faster">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    <!-- Category Chart -->
                    <div
                        class="bg-gradient-to-tl from-sky-950 to-[#131924] bg-opacity-25 chart-container p-6 transition-all duration-300">
                    ...
                    <!-- Borrowing Chart -->
                    <div
                        class="bg-gradient-to-tl from-sky-950 to-[#131924] chart-container p-6 transition-all duration-300">
                        <div class="flex items-center justify-between mb-4">
