...
<body class="bg-[#10151D]">
        ...
        <div class="flex-1 overflow-auto">
            ...
            <header class="bg-[#131924] p-4 flex items-center justify-between sticky top-0 z-10">
                ...
                <div class="flex items-center space-x-4">
                    <div class="relative">
                        <form action="{{ route('admin.databarang.index') }}" method="GET">
            ...
            <main class="p-6 animate__animated animate__fadeIn animate__faster">
                ...
                <div class="bg-gradient-to-tl from-sky-950 to-[#131924] rounded-xl shadow-md p-6 mb-6 card-hover">
                    <form id="filterForm" action="{{ route('admin.databarang.index') }}" method="GET">
                                ...
                                @forelse ($items as $item)
                                    <tr class="table-row-hover">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <button
                                                onclick="confirmDelete('{{ route('admin.databarang.destroy', $item->id) }}', '{{ $item->nama_barang }}')"
        ...
        <div id="addModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <form id="addForm" action="{{ route('admin.databarang.store') }}" method="POST">
                        @csrf
    ...
    <script>
        ...
        function openEditModal(item) {
            document.getElementById('editForm').action = `/admin/databarang/${item.id}`;
