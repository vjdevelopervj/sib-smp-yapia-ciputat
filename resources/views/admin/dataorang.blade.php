        ...
        <div class="flex-1 overflow-auto">
            ...
            <header class="bg-[#131924] p-4 flex items-center justify-between sticky top-0 z-10">
                ...
                <div class="flex items-center space-x-4">
                    <div class="relative">
                        <form id="searchForm" action="{{ route('admin.dataorang.index') }}" method="GET">
            ...
            <main class="p-6 animate__animated animate__fadeIn animate__faster">
                ...
                <div class="bg-gradient-to-tl from-sky-950 to-[#131924] rounded-xl shadow-md p-6 mb-6 card-hover">
                    <form id="filterForm" action="{{ route('admin.dataorang.index') }}" method="GET">
                ...
                <div class="bg-gradient-to-tl from-sky-950 to-[#131924] rounded-lg shadow overflow-hidden">
                                ...
                                @forelse ($people as $person)
                                    <tr class="table-row-hover">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <button
                                                onclick="confirmDelete('{{ route('admin.dataorang.destroy', $person->id) }}', '{{ $person->nama }}')"
                    ...
                    <!-- Pagination -->
                    <div class="bg-[#1e293b] px-4 py-3 flex items-center justify-between border-t border-gray-700 sm:px-6"
                        id="pagination">
                            ...
                            <div class="overflow-x-auto max-w-[300px]">
                                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px flex-nowrap"
                                    ...
                                    @php
                                        ...
                                        $window = 5; // Total number of pages to show
        ...
        <div id="addModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <form id="addForm" action="{{ route('admin.dataorang.store') }}" method="POST">
                        @csrf
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <select name="jenis_kelamin" id="jenis_kelamin" required
                                                    class="mt-1 block w-full border rounded-md shadow --

System: You are Grok 3 built by xAI.

The response was cut off due to exceeding the maximum allowed tokens. Below is the continuation of the updated `dataorang.blade.php` file, ensuring the styling matches `databarang.blade.php`. The artifact continues from where the previous response ended, completing the modal and script sections while maintaining the same dark theme, colors, and design elements.

<xaiArtifact artifact_id="0467d7da-c2a8-43b3-a9d8-87cf0d503cf9" artifact_version_id="7f19101e-1ddc-4552-bd8a-3e6e72f8c85f" title="dataorang.blade.php" contentType="text/html">
                                                    -sm py-2 px-3 focus:outline-none">
    ...
    <script>
        ...
        function openEditModal(person) {
            document.getElementById('editForm').action = `/admin/dataorang/${person.id}`;
        ...
        function confirmDelete(url, personName) {
            Swal.fire({
                ...
                text: `Anda akan menghapus data ${personName}`,
                icon: 'warning',
