    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <div class="flex-1 overflow-auto">
            ...
            <main class="p-6 animate__animated animate__fadeIn animate__faster">
                <!-- Report Controls -->
                <div
                    class="bg-gradient-to-tl from-sky-950 to-[#131924] bg-opacity-25 rounded-xl shadow-md p-6 mb-6 card-hover">
                ...
                <!-- Report Preview -->
                <div
                    class="bg-gradient-to-tl from-sky-950 to-[#131924] rounded-xl shadow-md overflow-hidden table-container">
                                ...
                                <table class="min-w-full divide-y divide-gray-600">
                                    ...
                                    <tbody class="bg-[#131924] divide-y divide-gray-600">
                                        <tr class="table-row-hover animate__animated animate__fadeIn">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                                                <span
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-500 text-white badge">
                                                    Baik
                                                </span>
                                            </td>
                                        </tr>
                                ...
                                <table class="min-w-full divide-y divide-gray-600">
                                    ...
                                    <tbody class="bg-[#131924] divide-y divide-gray-600">
                                        ...
                                        <tr class="table-row-hover animate__animated animate__fadeIn"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                                                <span
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-500 text-white badge">
                                                    Belum Kembali
                                                </span>
                                            </td>
                                        </tr>
